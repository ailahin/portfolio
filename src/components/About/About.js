              ...
              <div class="col-6 ">
                ...
                <div className="education-details">
                  ...
                  <p className="text-special activities">
                    ...
                    Campus Forums and Talking to Students. <br />
                    •Report monthly to Union Parliament and Contribute to Student Voice newsletters. Also, Campaign for change get support from SU
                    to create policies.
                  </p>
